...
import com.ryohysk.graphqlkotlin.application.input.RemoveFavoriteProductsInput
...
class UserMutationResolver(private val productService: ProductService) : GraphQLMutationResolver {
    ...
    @Suppress("unused")
    fun removeFavoriteProducts(input: RemoveFavoriteProductsInput): Boolean {
        productService.removeFavoriteProducts(input.userId, input.productIds)
        return true
    }
}